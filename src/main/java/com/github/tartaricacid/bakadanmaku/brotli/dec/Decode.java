...
import com.github.tartaricacid.bakadanmaku.brotli.dec.*;
import com.github.tartaricacid.bakadanmaku.brotli.dec.State;
import com.github.tartaricacid.bakadanmaku.brotli.dec.Utils;

import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.BLOCK_START;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.CLOSED;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.COMPRESSED_BLOCK_START;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.COPY_LOOP;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.COPY_UNCOMPRESSED;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.COPY_WRAP_BUFFER;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.FINISHED;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.INSERT_LOOP;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.MAIN_LOOP;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.READ_METADATA;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.TRANSFORM;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.UNINITIALIZED;
import static com.github.tartaricacid.bakadanmaku.brotli.dec.RunningState.WRITE;
...
final class Decode {
  ...
  private static void decodeMetaBlockLength(BitReader br, com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
  ...
  private static void readHuffmanCodeLengths(
    ...
    com.github.tartaricacid.bakadanmaku.brotli.dec.Utils.fillWithZeroes(codeLengths, symbol, numSymbols - symbol);
  }
  ...
  private static int decodeContextMap(int contextMapSize, byte[] contextMap, BitReader br) {
    ...
    if (numTrees == 1) {
      com.github.tartaricacid.bakadanmaku.brotli.dec.Utils.fillWithZeroes(contextMap, 0, contextMapSize);
      return numTrees;
    }
  ...
  private static void decodeBlockTypeAndLength(com.github.tartaricacid.bakadanmaku.brotli.dec.State state, int treeType) {
  ...
  private static void decodeLiteralBlockSwitch(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
  ...
  private static void decodeCommandBlockSwitch(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
    decodeBlockTypeAndLength(state, 1);
    state.treeCommandOffset = state.hGroup1.trees[state.blockTypeRb[3]];
  }

  private static void decodeDistanceBlockSwitch(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
    decodeBlockTypeAndLength(state, 2);
    state.distContextMapSlice = state.blockTypeRb[5] << DISTANCE_CONTEXT_BITS;
  }

  private static void maybeReallocateRingBuffer(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
   ...
   */
  private static void readMetablockInfo(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static void readMetablockHuffmanCodesAndContextMaps(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static void copyUncompressedData(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static boolean writeRingBuffer(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
  ...
  static void setCustomDictionary(com.github.tartaricacid.bakadanmaku.brotli.dec.State state, byte[] data) {
   ...
   */
  static void decompress(com.github.tartaricacid.bakadanmaku.brotli.dec.State state) {
